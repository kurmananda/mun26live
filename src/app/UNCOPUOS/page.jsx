  ...
  const updateContry = async (cont, sat) => {
    if (sat === 'none') {
      ...
      if (isConfirmed) {
        ...
        window.location.href = '/paymentUNCOPUOS'
      }
        ...
        <div>
          ...
          <div className='w-full lg:w-3/5 mx-auto border h-[20vh] rounded-xl flex justify-center bg-gray-300 backdrop-blur-4xl bg-opacity-50 items-center gap-1 shadow-xl shadow-black'>
            <div className='border px-2 lg:px-5 py-2 rounded-xl bg-white w-1/4 bg-opacity-50'>
              <img src="uncopouschair.png" className='h-[8vh] lg:h-[10vh] rounded-xl mx-auto' alt="" />
            ...
            <div className='border py-2 px-2 lg:px-5 rounded-xl bg-white w-1/4 bg-opacity-50'>
              <img src="uncopousvicechair.png" className='h-[8vh] lg:h-[10vh] rounded-xl mx-auto' alt="" />
              <h2 className='text-xs text-gray-400'>Vice Chair</h2>
              <h1 className=''>VISMAYA</h1>
            </div>
            <div className='border py-2 px-2 lg:px-5 rounded-xl bg-white w-1/4 bg-opacity-50' >
              <img src="uncopuosdirector.png" className='h-[8vh] lg:h-[10vh] rounded-xl mx-auto' alt="" />
              <h2 className='text-xs text-gray-400'>Director</h2>
              <h1 className=''>Rilwan</h1>
            </div>
          </div>
          <h1 className="text-3xl font-bold text-center">Country Matrix</h1>
          <h1 className="text-lg text-gray-500 font-bold text-center mb-2">for UNCOPUOS</h1>
          ...
          <h1 className="text-sm lg:text-xl text-gray-200  text-center mb-2 mt-6">Agenda : Deliberations on Safeguarding Dark and Quiet Skies for Scientific and Societal Advancement.

            Addressing Small Satellite Deployment with Special Emphasis on Legal Challenges Faced by Developing Nations.</h1>
          {role === 'admin' ? (
            <div className='p-10'>
              <div className="mb-4">
              ...
              <Link className="w-full p-3 bg-blue-500 text-white rounded-lg hover:bg-blue-700" onClick={crtuu} href='/UNCOPUOS' > Submit </Link>
            </div>) : (
