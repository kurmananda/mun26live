    ...
    <div>
      <div className="flex flex-col p-10 justify-center items-center text-white">
        ...
        <div className="space-y-2 py-2 border rounded-xl lg:text-2xl p-2">
          <div className="flex justify-between"><h1>Individual Delegate : <br />[1399 + 600] = 1999</h1> <Link href={'upi://pay?pn=Kurma Lohitha Krithika&pa=9100629782@ptyes&cu=INR&am=1999'} className="bg-yellow-500 my-auto p-2 mx-5 rounded-xl">pay</Link></div><hr />
